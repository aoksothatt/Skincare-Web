...
const WelcomePage = () => {
  return <div>
    <div className="w-full h-screen bg-[#F9F8F6] py-35 px-25">
      <div className=" flex justify-between">
        <div className="w-[25%]">
          ...
          <button className=" mt-10 border border-green-900 w-55 h-13 rounded-xl flex items-center justify-center gap-2">View All Product <i class="bi bi-arrow-up-right-square-fill text-green-800 text-[42px]"></i></button>
          <div className="mt-20">
            <p className="w-60 font-bold text-lg relative">Make with<span className="text-5xl text-green-800 absolute translate-y-[-23%] translate-x-2"> 99%</span> 
            <p><strong>Natural Ingredient</strong> for Pure,Healthy Skin.</p></p>
          </div>
        </div>
        <div className="w-[40%] h-[450px] bg-[#84994F] rounded-[500px_90px] relative ">
